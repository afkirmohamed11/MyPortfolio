          ...
          {/* <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-2 text-white">Data_Engineer</span>
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Afkir Mohamed</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <span className="text-gray-400">{"', '"}</span>
              <span className="text-amber-300">Hadoop Ecosystem</span>
              <span className="text-gray-400">{"', '"}</span>
              ...
              <span className="text-gray-400">{"', '"}</span>
              <span className="text-amber-300">Casandra</span>
              <span className="text-gray-400">{"', '"}</span>
